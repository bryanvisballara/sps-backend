...
const importCostSchema = new Schema(
  {
    ...
    invoicedSaleUnitUsd: { type: Number, default: 0, min: 0 },
    invoicedSaleUnitCop: { type: Number, default: 0, min: 0 },
    invoicedLineTotalCop: { type: Number, default: 0, min: 0 },
    invoicedLineUtilityCop: { type: Number, default: 0 },
    invoiceGeneratedAt: { type: Date, default: null },
    invoiceClientId: { type: String, trim: true, default: "" },
    invoiceClientCode: { type: String, trim: true, default: "" },
    invoiceClientName: { type: String, trim: true, default: "" },
    invoiceClientManagerName: { type: String, trim: true, default: "" },
    invoiceClientEmail: { type: String, trim: true, default: "" },
    invoiceClientPhone: { type: String, trim: true, default: "" },
    invoiceClientAddress: { type: String, trim: true, default: "" },
